...
lbl.place(relx=0.1, rely=0.7, relwidth=0.15, relheight=0.04)

entry = tk.Entry(bg='white', font=('Segoe UI', 10), justify=CENTER)
entry.place(relx=0.1, rely=0.75, relwidth=0.15, relheight=0.05)
...
button.place(relx=0.3, rely=0.75, relheight=0.05, relwidth=0.2)
...
button_2.place(relx=0.7, rely=0.75, relheight=0.05, relwidth=0.2)

lbl_error = Label(root, text='', fg='red')
lbl_error.place(relx=0.02, rely=0.8, relwidth=0.3, relheight=0.04)
